        ...
        <div className="grid grid-cols-2 w-full">
          ...
          <div className="flex flex-col justify-center gap-5">
            <form className="flex flex-col justify-center gap-5" onSubmit={handleSubmit}>
              <div className="w-1/2">
                <input className="bg-Fontpurple appearance-none rounded-xl w-full py-2 px-4 text-white leading-tight focus:outline-none focus:border-purple-500" id="mobileNumber" type="text" placeholder="Mobile Number" value={mobileNumber} onChange={(e) => setMobileNumber(e.target.value)} />
              </div>
              <div className="w-1/2">
