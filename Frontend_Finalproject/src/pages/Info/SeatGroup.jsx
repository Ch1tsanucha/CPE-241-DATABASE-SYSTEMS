...
export default function SeatGroup() {
  ...
  return (
    <div>
      ...
      <h3 className="font-bold">SEATING</h3>
      <div className="flex gap-1 justify-center mb-10">
        <div className="border-2 border-white mr-2 bg-white h-8 w-full rounded-lg flex items-center px-6">
